...
// Query data
$query = $koneksi->query("SELECT * FROM tb_nasabah $where");
?>
    ...
    <div class="container">
        ...
        <div class="content pt-5 ms-250 px-3">
            ...
            <form class="d-flex mb-3" method="GET">
                <input class="form-control me-2" type="search" name="search" placeholder="Cari nasabah..." value="<?= htmlspecialchars($keyword) ?>">
                <button class="btn btn-outline-primary" type="submit">Cari</button>
            </form>

            <!-- Tombol Tambah -->
            <button class="btn btn-success mb-3" data-bs-toggle="modal" data-bs-target="#modalTambah">+ Tambah Nasabah</button>
            ...
            <table class="table table-striped-columns table-hover">
                ...
                <tbody>
                    <?php
                    $no = 1;
                    $query = $koneksi->query("SELECT * FROM tb_nasabah");
                    ...
                    ?>
                        <tr>
                            ...
                            <td><?= htmlspecialchars($row['saldo_poin']) ?></td>
