...
cekHakAkses(['superadmin', 'admin']); // superadmin & admin boleh
    ...
    <div class="card shadow-sm border-0 p-3">
        <div class="card-body">
            ...
            <form class="d-flex mb-3" method="GET">
                <input class="form-control me-2" type="search" name="search" placeholder="Cari petugas..."
            ...
            <table class="table table-striped-columns table-hover">
                ...
                <tbody class="table-secondary">
                    <?php if (empty($data)): ?>
                        <tr>
                            <td colspan="8" class="text-center">Tidak ada data petugas ditemukan.</td>
                        </tr>
                    <?php else: ?>
                        <?php
                        foreach ($data as $index => $row):
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <!-- tombol edit -->
                                    <a href="ubah_petugas.php?id=<?= $row['id'] ?>" class="btn btn-sm btn-warning">Edit</a>
                                    <!-- tombol hapus -->
                                    <a href="hapus_petugas.php?id=<?= $row['id'] ?>"
